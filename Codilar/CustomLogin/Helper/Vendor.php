...
class Vendor extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    */
    ...
    public function isAVendorAndAccountApproved()
    {
        ...
        //$isVendor=$this->_customerSession->getCustomer ()->getId ();
    ...
    public function getVendorHomepageUrl()
    {
        ...
        return $this->urlBuilder->getUrl('homepage/'.$shopUrl);
    }

    public function getVendorCommissionUrl()
    {

        return $this->urlBuilder->getUrl('seller/commission/index');
    }
